...
public class Map
{
    ...
    public Map()
    {
        ...
        cave.pickupables.Add(new PickUp(2, "Oxygen Tank", "An oxygen tank that refills your oxygen level by 20%."));
        ...
        forest.pickupables.Add(new PickUp(1, "Hat", "Dirty old hat"));
        ...
        town.look = new string[]
        {
            ...
            "To the west is your crashed spaceship.",
        ...
        tavern.name = "Tavern";
        tavern.quests.Add(new Quest(1, "Hat", "Bring the hat from the forest to the old man"));
        ...
        tavern.talk =
            "Hey there, I have a mission for you! \n \n I've lost my hat in the forest I need you to bring it back to me. \n I'll give you reward once you bring me that hat";
